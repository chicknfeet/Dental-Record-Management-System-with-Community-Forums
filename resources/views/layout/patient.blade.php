    ...
    <header>
        <nav>
            <div id="mySidenav" class="sidenav">
                ...
                @if(auth()->check())
                    <a href="{{route('patient.appointment')}}">Appointment</a>
                    <a href="{{route('patient.messages')}}">Messages</a>
                    <a href="{{route('patient.paymentinfo')}}">Payment Info</a>
                    <a href="{{route('patient.communityforum')}}">Community Forum</a>
                    <a href="{{route('patient.logout')}}">Log Out</a>
                @else
