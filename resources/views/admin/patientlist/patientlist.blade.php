            ...
            <tbody>
                @foreach ($patientlist as $patient)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('showPatient', $patient->id) }}" class="btn btn-info">View</a>
                            <a href="{{ route('updatePatientlist', $patient->id) }}" class="btn btn-warning">Update</a>
                            <form method="post" action="{{ route('deletePatientlist', $patient->id) }}" style="display: inline;">
                                @csrf
                                @method('DELETE')
